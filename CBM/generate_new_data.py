"""
Create variants of the initial CBM dataset
"""
import os
import sys
import copy
...
def mask_image(file_path, out_dir_name, remove_bkgnd=True):
    """
    Remove background or foreground (if remove_bkgnd is False) using segmentation label stored in segmentations/ folder in CBM dataset
